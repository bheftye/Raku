...
function verImagen(imagen){
	...
	popup.document.open();
	popup.document.writeln("<HTML><HEAD><TITLE>Imagen</TITLE></HEAD>");
	popup.document.writeln("<BODY><TABLE ALIGN=\"CENTER\"><TR><TD>");
	popup.document.writeln("<IMG SRC=\"" + imagen + "\" WIDTH=\"460\" HEIGHT=\"550\" ALT=\"Fotografía\" BORDER=\"1\">");
	popup.document.writeln("</TD></TR></TABLE></BODY></HTML>");
